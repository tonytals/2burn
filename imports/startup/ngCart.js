...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', '$window', 'ngCartItem', 'store', function ($rootScope, $window, ngCartItem, store) {
        ...
        this.setCartOwner = function(cartOwner){
            this.$cart.cartOwner = cartOwner;
            return this.getCartOwner();
        };

        this.getCartOwner = function(){
            return  this.getCart().cartOwner;
        };
        ...
        this.getMyCart = function () {
            //console.log(JSON.stringify(this.getCart()));
